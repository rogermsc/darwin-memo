...
equal their published twins exactly on all $21$ metrics the two files
share --- \texttt{cum\_delta}, \texttt{final\_population},
\texttt{poison\_killed}, \texttt{poison\_alive\_final}, the probe
rates --- with the two fired counters the only fields that differ. The
