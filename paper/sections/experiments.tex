...
which range to $50$. Across the entire matrix, $246$ lessons were minted
and $10$ starved: none whatsoever on pytest, and five each for
\texttt{memory\_on} and \texttt{random\_matched} at the tail of astropy,
where the first-born entries finally cross zero. With nothing starving,
