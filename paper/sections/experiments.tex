...
and reported there as unmeasured (\S\ref{sec:related}); \S\ref{sec:whocanlie}
says who can reach the settlement channel without owning the resource
behind it, and what follows is the measurement.
